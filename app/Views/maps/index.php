    ...
    <script>
        ...
        function onEachFeature(feature, layer) {
            layer.bindPopup("<h4>Jumlah Penduduk Kebumen 2018</h4><br>" + feature.properties.Kecamatan + " : " + feature.properties.nilai + " ribu jiwa");
            layer.on({
        ...
        info.update = function(props) {
            this._div.innerHTML = '<h4><?= $masterData->nama ?></h4>' + (props ?
                '<b>' + props.Kecamatan + '</b><br />' + props.nilai + ' ' :
                'Seret di Atas wilayah');
        };
